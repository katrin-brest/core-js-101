...
function timeSpanToString(startDate, endDate) {
  ...
  const mm = Math.floor((timestamp - hh * 3600000) / 60000);
  const ss = Math.floor((timestamp - hh * 3600000 - mm * 60000) / 1000);
...
function angleBetweenClockHands(date) {
  const hh = date.getUTCHours() < 12 ? date.getUTCHours() : date.getUTCHours() - 12;
  let grad = Math.abs(0.5 * (60 * hh - 11 * date.getMinutes()));
  grad = grad < 180 ? grad : 360 - grad;
